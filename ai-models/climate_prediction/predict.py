"""
climate_prediction/predict.py
Runs predictions for Climate Prediction and integrates Explainable AI.
"""
...
def predict(input_data: dict) -> dict:
    """
    Predict climate condition based on input data and return prediction, confidence, and explanation.
    ...
    try:
        ...
        raise KeyError(f"Missing required climate prediction feature: {e}")
    ...
    condition_label = model_data["target_mapping"].get(prediction_class, "Unknown")
    ...
    explanation = explain_prediction(
        ...
        target_type="classification",
        target_name="Climate Condition"
    )
    
    return {
        "status": "success",
        "climate_prediction": condition_label,
